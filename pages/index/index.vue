<template>
	<view class="page">
		...
		<view class="notify-container" @click="toPage('消息提醒', '../message_list/message_list')">
			...
			<image src="../../static/icon-2.png" class="more-icon" mode="widthFix"></image>
		</view>
		<view class="nav-container">
			<view class="nav-row">
				<view class="nav" @click="toPage('在线签到', '../checkin/checkin')">
